...
VkApplicationInfo appInfo{};
        ...
        uint32_t extensionCount2 = 0;
         vkEnumerateInstanceExtensionProperties(nullptr, &extensionCount2, nullptr);
         std::vector<VkExtensionProperties> extensions2(extensionCount2);
         vkEnumerateInstanceExtensionProperties(nullptr, &extensionCount2, extensions2.data());
...
//        }
    ...
    void createGraphicsPipeline() {
        ...
        rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE;            rasterizer.depthBiasEnable = VK_FALSE;
...
//        vkCmdDraw(commandBuffer, static_cast<uint32_t>(vertices.size()), 1, 0, 0);    vkCmdEndRenderPass(commandBuffer);
        ...
        vkCmdDrawIndexed(commandBuffer, static_cast<uint32_t>(indices.size()), 1, 0, 0, 0);    vkCmdEndRenderPass(commandBuffer);
